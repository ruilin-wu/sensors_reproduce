...
void getBitWidth_io_outValid(int* result) {
           svScope prev = setScopeToTestBench();
           getBitWidthImpl_io_outValid(result);
           svSetScope(prev);
        }
void getBits_io_outValid(svBitVecVal* result) {
           svScope prev = setScopeToTestBench();
           getBitsImpl_io_outValid(result);
           svSetScope(prev);
        }
...
void getBitWidth_io_inValid(int* result) {
           svScope prev = setScopeToTestBench();
           getBitWidthImpl_io_inValid(result);
           svSetScope(prev);
        }
void getBits_io_inValid(svBitVecVal* result) {
           svScope prev = setScopeToTestBench();
           getBitsImpl_io_inValid(result);
           svSetScope(prev);
        }
void setBits_io_inValid(const svBitVecVal* data) {
           svScope prev = setScopeToTestBench();
           setBitsImpl_io_inValid(data);
           svSetScope(prev);
        }
  ...
  switch (id) {
    ...
    case 6: // io_upCount
      ...
      *getter = (void(*)(uint8_t*))getBits_io_upCount;
      return 0;
    case 7: // io_outValid
      getBitWidth_io_outValid(bitWidth);
      *getter = (void(*)(uint8_t*))getBits_io_outValid;
      return 0;
    case 8: // io_prefix_0
    ...
    case 11: // io_prefix_3
      ...
      *getter = (void(*)(uint8_t*))getBits_io_prefix_3;
      return 0;
    case 12: // io_inValid
      getBitWidth_io_inValid(bitWidth);
      *getter = (void(*)(uint8_t*))getBits_io_inValid;
      return 0;
    default:
      return -1;
  }
...
int port_setter(int id, int *bitWidth, void (**setter)(const uint8_t*)) {
  switch (id) {
    ...
    case 12: // io_inValid
      getBitWidth_io_inValid(bitWidth);
      *setter = (void(*)(const uint8_t*))setBits_io_inValid;
      return 0;
    default:
      return -1;
  }
