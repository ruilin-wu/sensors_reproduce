...
using VsvsimTestbench__Vcb_getBitWidthImpl_io_inValid_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value);
using VsvsimTestbench__Vcb_getBitWidthImpl_io_outValid_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value);
...
using VsvsimTestbench__Vcb_getBitsImpl_io_inValid_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_io_inValid);
using VsvsimTestbench__Vcb_getBitsImpl_io_outValid_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_io_outValid);
...
using VsvsimTestbench__Vcb_setBitsImpl_io_inValid_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ value_io_inValid);
