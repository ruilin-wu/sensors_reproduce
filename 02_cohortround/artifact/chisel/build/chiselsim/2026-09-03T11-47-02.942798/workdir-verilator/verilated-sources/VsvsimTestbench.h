...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    static void getBitWidthImpl_io_inValid(int* value);
    static void getBitWidthImpl_io_outValid(int* value);
    ...
    static void getBitsImpl_io_inValid(svBitVecVal* value_io_inValid);
    static void getBitsImpl_io_outValid(svBitVecVal* value_io_outValid);
    ...
    static void setBitsImpl_io_inValid(const svBitVecVal* value_io_inValid);
